<template>
  ...
  >
    <div
      v-show="props.tostType === 'success' && props.content"
      id="toast-success"
    ...
    >
      ...
      <div class="ml-3 text-sm font-normal">{{ props.content }}</div>
    </div>
    <div
      v-show="props.tostType === 'danger' && props.content"
      id="toast-danger"
      class="flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
      role="alert"
    >
    ...
    <div
      v-show="props.tostType === 'warning' && props.content"
      id="toast-warning"
...
const isShow = computed(() => {
  return props.tostType !== '' && props.content !== ''
})
